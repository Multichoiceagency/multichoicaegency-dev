...
const HeroSection: React.FC<HeroSectionProps> = ({ videoSrc }) => {
  ...
  return (
    <section ref={sectionRef} className="relative w-full min-h-screen bg-black overflow-hidden">
      <div className="spline-container absolute inset-0 w-full h-full z-0">
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-48 md:pl-[5%] relative z-20">
        ...
        >
          <h1 className="text-5xl md:text-6xl lg:text-7xl text-white font-bold leading-[1.1] tracking-tight">
            Multichoiceagency
            <br />
            jouw full service digital agency
          </h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 mb-16">
          ...
          >
            <p className="text-gray-300 text-lg">
              Als full service digital agency helpen we marketeers, ontwerpers en ontwikkelaars samen te werken om
              digitale ervaringen te bouwen, beheren en optimaliseren die resultaat opleveren.
            </p>
          </div>
          ...
          >
            ...
            <Link href="/contact">
              <Button className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white border-0 rounded-md px-6 py-6 text-base font-medium flex items-center whitespace-nowrap">
        ...
        >
          <div className="border-t border-[#5a7a4f]/30 pt-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-white font-bold">Ontwerpen en bouwen</h3>
            </div>
            <p className="text-gray-400 text-sm">
              We leven volgens onze eigen code, beginnend met jouw context voordat we in technologie duiken.
            </p>
          </div>
          ...
          <div className="border-t border-[#5a7a4f]/30 pt-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-white font-bold">Publiceren en bewerken</h3>
            </div>
            <p className="text-gray-400 text-sm">
              Geen code zonder context - we starten in jouw wereld, niet met technologie.
            </p>
          </div>
          ...
          <div className="border-t border-[#5a7a4f]/30 pt-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-white font-bold">Analyseren en optimaliseren</h3>
            </div>
            <p className="text-gray-400 text-sm">
              We starten niet met techniek maar in jouw wereld, met begrip van jouw unieke context.
            </p>
          </div>
          ...
          <div className="border-t border-[#5a7a4f]/30 pt-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-white font-bold">Schalen en samenwerken</h3>
            </div>
            <p className="text-gray-400 text-sm">
              We leven volgens onze eigen code, met focus op jouw behoeften voordat we technologische oplossingen
              bieden.
            </p>
          </div>
        </div>
