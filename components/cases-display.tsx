...
export default function Portfolio() {
  ...
  useEffect(() => {
    if (flickityContainerRef.current) {
      flickityRef.current = new Flickity(flickityContainerRef.current, {
        cellAlign: "left",
        freeScroll: true,
        contain: true,
        friction: 0.15,
      ...
      <div className="container px-4 mx-auto overflow-visible">
        ...
        <div className="flex flex-wrap items-center -mx-4 mb-16">
          <div className="w-full xl:w-2/3 px-4 mb-8 xl:mb-0">
            ...
            <h2 className="max-w-2xl font-heading text-3xl sm:text-4xl dark:text-white">
              Ontdek onze recente projecten en innovaties.
            </h2>
          </div>
          <div className="w-full xl:w-auto ml-auto px-4 xl:text-right">
            <Link
              href="/cases"
              className="inline-block w-full sm:w-auto py-4 px-6 text-center font-heading font-medium text-base text-gray-900 dark:text-white border border-gray-900 dark:border-white hover:text-green-500 hover:border-green-500 rounded-sm transition duration-150"
            >
              Bekijk alle cases
            </Link>
          </div>
            ...
            <div key={caseItem.id} className="w-80 sm:w-96 md:w-[400px] p-2">
              <div className="relative rounded-lg overflow-visible shadow-lg bg-white dark:bg-gray-800">
                ...
                <div className="p-6">
                  ...
                  <h3 className="font-heading text-xl sm:text-2xl text-gray-900 dark:text-white mb-4">
                  ...
                  >
                    <span className="mr-4">Bekijk project</span>
                    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-300 group-hover:bg-gray-200">
