      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <span className="text-xs text-white/60 ml-2 group-hover:text-white transition-colors duration-300">
            ...
            <div className="mt-4 flex justify-end">
              <a
          href="essict.nl/veiligheid-en-compliance"
          className="inline-flex items-center text-sm text-white/70 hover:text-[#a6e267] transition-colors duration-300 group-hover:translate-x-1 transition-transform duration-500"
              >
          <span>Meer informatie</span>
          <ArrowRight className="ml-1 h-3 w-3" />
          ...
          <div className="col-span-12 md:col-span-4 flex items-center justify-center animatable fade-in-up delay-9">
            ...
            <a
              href="/cases"
              className="bg-[#1a1a1a]/80 backdrop-blur-sm border border-[#333333] rounded-lg py-2 px-4 flex items-center justify-center w-full hover:border-[#a6e267] hover:bg-[#1a1a1a] transition-all duration-300 group relative overflow-hidden no-underline"
            >
          ...
          <div className="col-span-12 md:col-span-4 flex items-center justify-center animatable fade-in-up delay-11">
            {/* Next.js Link usage for button */}
            {/* eslint-disable-next-line @next/next/no-html-link-for-pages */}
            <a
              href="/contact"
              className="bg-[#2D4625] border border-[#2D4625] rounded-lg py-2 px-4 flex items-center justify-center w-full hover:bg-[#a6e267] hover:border-[#a6e267] hover:text-[#2D4625] transition-all duration-300 group relative overflow-hidden no-underline"
            >
