        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          >
            <h1 className="text-5xl font-bold mb-6 text-white leading-tight">
              Laten we samen iets{" "}
              <span className="text-lime-400">geweldigs</span> bouwen
            </h1>
            <p className="text-xl max-w-2xl text-gray-100 mb-8">
              Neem contact op met Multichoice Agency voor al uw digitale
              oplossingen. Wij staan klaar om uw vragen te beantwoorden en uw
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Kies de afdeling die het beste bij je vraag past voor de snelste
                service
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <Card className="rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 h-full border-0 overflow-hidden group bg-white">
                ...
                <CardContent className="space-y-6 pt-4">
                  <p className="text-gray-600">
                    Heb je een vraag over een betaling of factuur? Neem dan
            ...
            >
              <Card className="rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 h-full border-0 overflow-hidden group dark:bg-white">
                ...
                <CardContent className="space-y-6 pt-4">
                  <p className="text-gray-600">
                    Ben je al klant en heb je een vraag over onze service of
                    support nodig?
                  </p>
            ...
            >
              <Card className="rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 h-full border-0 overflow-hidden group dark:bg-white">
                ...
                <CardContent className="space-y-6 pt-4">
                  <p className="text-gray-600">
                    Ben je nog geen klant, maar wil je meer weten over onze
            ...
            {[
              {
                ...
                name: "WhatsApp",
                color: "bg-green-500",
                url: "https://wa.me/31103220410",
              },
              {
                icon: faLinkedin,
                name: "LinkedIn",
                color: "bg-blue-600",
                url: "https://www.linkedin.com/company/multichoiceagency",
              },
              {
                icon: faFacebook,
                name: "Facebook",
                color: "bg-blue-700",
                url: "https://www.facebook.com/share/1FTW3JYC7M/?mibextid=wwXIfr",
              },
              {
                icon: faInstagram,
                name: "Instagram",
                ...
                url: "https://www.instagram.com/multichoiceagency?igsh=MTA2NHp1djFoZWpzdA%3D%3D&utm_source=qry",
              },
              {
                icon: faTiktok,
                name: "TikTok",
                color:
                  "bg-gradient-to-r from-gray-500 via-gray-500 to-green-500",
                url: "http://www.tiktok.com/@multichoiceagency7",
              },
            ].map((social, index) => (
              <motion.a
                key={social.name}
      ...
      <section id="contact-form" className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-2xl text-white py-6 text-center font-bold">
                Contactformulier
              </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-md">
                  <h3 className="font-semibold text-xl mb-4 text-black dark:text-white">
                    Hoofdkantoor
                  </h3>
                  <div className="flex items-start space-x-3 text-gray-600 dark:text-white mb-4">
                    ...
                    <div>
                      ...
                      <p>Otto Reuchlin 1008 / 1146, 3072 MD Rotterdam</p>
                      <p className="font-bold text-black dark:text-white">
                        Kom langs in onze kantoor in Rotterdam, koffie staat
                        klaar!
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 text-gray-600 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-white">
                        (vrijdag telefonisch bereikbaar tot 12:30)
                      </p>
                    </div>
                  </div>
                </div>
            ...
            >
              <div className="absolute inset-0">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2461.5739410957744!2d4.483325442784908!3d51.905238959132724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c43365597b2079%3A0xaa989ba3db19f168!2s3072%20MD%20Rotterdam!5e0!3m2!1snl!2snl!4v1756677381132!5m2!1snl!2snl"
                  title="Google Maps – 3072 MD Rotterdam"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  loading="lazy"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Antwoorden op de meest gestelde vragen over onze diensten en
                werkwijze
              </p>
            </motion.div>
          </div>
          <div className="max-w-3xl mx-auto">
              ...
              {[
                {
                  ...
                  answer:
                    "U kunt een offerte aanvragen via ons contactformulier op deze pagina, door te mailen naar sales@multichoiceagency.nl of door te bellen naar 010-3220410. We nemen dan zo snel mogelijk contact met u op om uw wensen te bespreken.",
                },
                {
                  question: "Wat zijn de kosten voor jullie diensten?",
                  answer:
                    "De kosten voor onze diensten zijn afhankelijk van uw specifieke wensen en de omvang van het project. We stellen graag een offerte op maat voor u op na een vrijblijvend gesprek.",
                },
                {
                  question: "Hoe lang duurt het om een project af te ronden?",
                  answer:
                    "De doorlooptijd van een project is afhankelijk van de complexiteit en omvang. Een eenvoudige website kan binnen enkele weken worden opgeleverd, terwijl complexere projecten enkele maanden kunnen duren. We maken vooraf duidelijke afspraken over de planning.",
                },
                {
                  question:
                    "Bieden jullie ook onderhoud en support na oplevering?",
                  answer:
                    "Ja, we bieden verschillende onderhouds- en supportpakketten aan om ervoor te zorgen dat uw digitale oplossing optimaal blijft functioneren. Neem contact op met onze supportafdeling voor meer informatie.",
                },
                {
                  question: "Werken jullie ook voor klanten buiten Nederland?",
                  answer:
                    "Ja, we werken voor klanten in heel Nederland en daarbuiten. Dankzij moderne communicatiemiddelen kunnen we effectief samenwerken, ongeacht uw locatie.",
                },
              ].map((faq, index) => (
                <motion.div
                  key={index}
            ...
            <div className="mt-12 text-center">
              <p className="text-gray-600 mb-6">
                Heeft u een andere vraag die hier niet wordt beantwoord?
              </p>
              <Button
                className="bg-green-900 hover:bg-green-800 text-white"
                onClick={() =>
