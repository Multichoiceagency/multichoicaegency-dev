...
export default function WebsitesPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <section className="py-20 bg-[#1E1934] relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="relative z-10 max-w-3xl mx-auto">
            <div className="mb-12">
              <div className="rotate-90 origin-left translate-y-[-100%] absolute top-0 left-0 text-primary/60 text-sm tracking-wider">
                BESTE OPLOSSING?
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
                Advies over de beste oplossing voor jouw organisatie
              </h2>
              <p className="text-gray-400 text-lg">
                Vul je gegevens in en we nemen contact met je op om jouw doelen en wensen te bespreken. Op basis daarvan geven we advies over de mogelijkheden en werken we samen aan een website die echt resultaat oplevert.
              </p>
            </div>
            ...
            <form className="space-y-6">
              ...
              />
              <Button className="h-14 px-8 bg-primary hover:bg-primary/90 text-white">
                Verzenden
              </Button>
            </form>
            ...
            <div className="flex items-center gap-4 mt-12">
              ...
              <div>
                <div className="font-semibold text-white">Joost Klein</div>
                <div className="text-gray-400">Commercieel Directeur</div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 left-0 w-full h-full" style={{
              background: 'linear-gradient(45deg, transparent 45%, #1E7933 45%, #1E7933 55%, transparent 55%)',
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-[#1E7933] via-[#145024] to-[#0d3015] dark:from-[#2A9D47] dark:via-[#1E7933] dark:to-[#145024]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Klaar om jouw website naar het volgende niveau te tillen?
          </h2>
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Laat ons je helpen met het realiseren van jouw digitale ambities.
          </p>
          <Button className="group gap-2 rounded-full bg-white text-primary hover:bg-gray-100 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700">
            Start je project
            <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
          </Button>
        </div>
