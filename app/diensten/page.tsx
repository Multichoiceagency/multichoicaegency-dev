...
const sections = [
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        href: "https://www.essmedia.nl/productfotografie",
        icon: <Camera className="w-4 h-4 inline mr-1" />,
      },
      {
        name: "Drone Video & Foto (via EssMedia)",
        href: "https://www.essmedia.nl/drone-video-foto",
        icon: <Camera className="w-4 h-4 inline mr-1" />,
      },
      {
        name: "Animatievideo's (via EssMedia)",
        href: "https://www.essmedia.nl/animatie-video-laten-maken",
        icon: <Video className="w-4 h-4 inline mr-1" />,
      },
    ],
  ...
  },
  {
    ...
    services: [
      ...
      { name: "AI automatisering met n8n of zapier", href: "/ai-oplossingen/ai-automatisering" },
      { name: "AI VoIP & Klantenservice Automatisering", href: "/ai-oplossingen/ai-voip-klantenservice" },
      { name: "AI Content Generatie & Optimalisatie", href: "/ai-oplossingen/ai-content-creatie" },
      { name: "AI Gedreven Data Analyse & Inzichten", href: "/ai-oplossingen/ai-data-analyse" },
      { name: "Custom AI Model Ontwikkeling", href: "/ai-oplossingen/custom-ai-modellen" },
      { name: "AI Strategie & Marketing", href: "/ai-oplossingen/ai-marketing" },
    ],
    cta: "/ai-oplossingen",
